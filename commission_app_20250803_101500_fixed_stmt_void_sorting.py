                    ...
                    if selection_available:
                        ...
                        if view_mode != "Aggregated by Policy" and 'Policy Number' in editable_data.columns:
                            ...
                            for group_name in unique_groups:
                                ...
                                if len(group_df) > 0:
                                    ...
                                    # 4. STMT/VOID transactions (sort by STMT DATE)
                                    stmt_void_df = group_df[is_stmt_void].sort_values('STMT DATE')
                        ...
                        with st.expander("💡 **Tips for Better Navigation**", expanded=False):
                            ...
                            **📋 Transaction Sort Order:**
                            ...
                            4. **STMT/VOID** - Payment records sorted by STMT Date
                            
                            This ordering follows the natural policy lifecycle and makes it easy to track the progression of each policy term.
