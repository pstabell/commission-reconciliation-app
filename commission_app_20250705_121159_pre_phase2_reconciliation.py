    ...
    # --- Reconciliation ---
        ...
        with rec_tab1:
            ...
            if import_method == "Manual Entry":
                ...
                # Get unreconciled transactions for the carrier
                if carrier_name and not all_data.empty:
                    ...
                    if not unreconciled.empty:
                        ...
                        with st.expander("ℹ️ How Transaction IDs Work"):
                            st.write("""
                            **Original Transactions** keep their existing IDs (e.g., `DXG14C8`)
                            
                            **Reconciliation Entries** will be created with special IDs that include:
                            - A new unique 7-character code
                            - The suffix `-STMT-`
                            - The statement date
                            
                            **Example**: When you reconcile transaction `DXG14C8`, a new entry will be created with an ID like `A1B2C3D-STMT-20240630`
