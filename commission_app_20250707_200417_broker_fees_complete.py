...
def main():
                        ...
                        if not edit_results.empty:
                            ...
                            if st.session_state.get('show_edit_modal', False):
                                ...
                                with st.form("edit_transaction_form"):
                                    ...
                                    # Premium & Fee Information (NEW)
                                    st.markdown("#### Premium & Fee Information")
                                    col5, col6 = st.columns(2)
                                    ...
                                    with col6:
                                        ...
                                        updated_data['Policy Taxes & Fees'] = st.number_input(
                                            ...
                                            help="Non-commissionable taxes and fees"
                                        )
                                        ...
                                        st.number_input(
                                            ...
                                            disabled=True,
                                            help="Premium Sold minus Policy Taxes & Fees"
                                        )
    ...
    # --- Add New Policy Transaction ---
        ...
        with st.form("add_policy_form"):
            ...
            # Premium & Fee Information Section (NEW)
            st.subheader("Premium & Fee Information")
            col1, col2 = st.columns(2)
            with col1:
                # Use premium from calculator if available
                premium_sold_value = premium_sold if 'premium_sold' in locals() else 0.0
                premium_sold_input = st.number_input("Premium Sold ($)", value=premium_sold_value, format="%.2f", step=100.0)
            ...
            with col2:
                policy_taxes_fees = st.number_input("Policy Taxes & Fees ($)", value=0.0, format="%.2f", step=10.0, help="Non-commissionable taxes and fees")
                # Calculate and display commissionable premium
                commissionable_premium = premium_sold_input - policy_taxes_fees
                st.text_input("Commissionable Premium ($)", value=f"{commissionable_premium:.2f}", disabled=True, help="Premium Sold minus Policy Taxes & Fees")
                ...
                if customer and policy_number:
                    try:
                        ...
                        new_policy = {
                            ...
                            "Premium Sold": clean_numeric_value(premium_sold_input),
