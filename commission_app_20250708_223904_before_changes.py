...
def main():
    ...
    # --- Add New Policy Transaction ---
        ...
        with st.form("add_policy_form"):
            ...
            with col2:
                policy_gross_comm_percent = st.number_input("Policy Gross Comm %", value=10.0, format="%.2f", min_value=0.0, max_value=100.0, key="policy_gross_comm_calc")
            with col3:
            ...
            with col1:
                ...
                policy_gross_comm_input = st.number_input("Policy Gross Comm %", value=policy_gross_comm_value, format="%.2f", min_value=0.0, max_value=100.0, key="policy_gross_comm_details")
