    ...
    # --- Policy Revenue Ledger Reports ---
        ...
        if all_data.empty:
            ...
            if view_mode == "Aggregated by Policy":
                ...
                # Transaction-level columns for detailed view (existing default)
                default_columns = ["Customer", "Policy Number", "Total Agent Comm", "Agent Paid Amount (STMT)", "Policy Balance Due"]
                    ...
                    if len(hidden_df) > 0:
                        ...
                        if selected_columns:
                            ...
                            if view_mode == "Aggregated by Policy":
                                ...
                                display_cols = ['Transaction ID', 'Customer', 'Policy Number', 'Policy Type', 'Transaction Type', 
                                              'Total Agent Comm', 'Agent Paid Amount (STMT)', 'Policy Balance Due']
