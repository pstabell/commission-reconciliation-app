...
\echo 'Current data (normalized structure):'
SELECT user_id, user_email, policy_type, display_order, is_active 
...
SELECT user_email, jsonb_array_length(policy_types) as type_count, policy_types
...
\echo ''
\echo 'Adding default policy types...'
...
\echo ''
\echo '✅ Successfully migrated from normalized to JSONB structure!'
\echo '✅ Each user now has Personal Lines + 25 default policy types'