-- PostgreSQL schema for Supabase deployment (SAFE VERSION - No DROP statements)
-- This version is safe for first-time import to Supabase
...
CREATE INDEX IF NOT EXISTS idx_policies_transaction_type ON policies(transaction_type);
