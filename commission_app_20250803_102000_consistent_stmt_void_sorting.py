                        ...
                        if view_mode != "Aggregated by Policy" and 'Policy Number' in editable_data.columns:
                            ...
                            for group_name in unique_groups:
                                ...
                                if len(group_df) > 0:
                                    ...
                                    new_rwl_df = non_stmt_void_df[is_new_rwl]
                                    ...
                                    if len(stmt_void_df) > 0:
                                        ...
                                        stmt_void_df = pd.concat([stmt_new_rwl, stmt_end, stmt_other], ignore_index=False)
                                    
                                    # Combine in the desired order
                                    sorted_group = pd.concat([new_rwl_df, end_df, other_df, stmt_void_df], ignore_index=False)
